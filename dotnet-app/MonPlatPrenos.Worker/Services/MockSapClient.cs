...
{
    private static readonly IReadOnlyList<SapOrderHeader> Orders =
    [
        new("000005223286", "000012080000000000", "REL", 110, DateTime.Today, "TRAK-01", "200", "1061"),
        new("000005223287", "000019789000000000", "REL", 95, DateTime.Today, "TRAK-02", "200", "1061"),
        new("000005223288", "000011000000000000", "TEHZ", 80, DateTime.Today, "TRAK-03", "200", "1061")
    ];
    ...
    {
        IReadOnlyList<SapOperation> result =
        [
            new(orderNumber, "C1", "PP04", 10, "0010"),
            new(orderNumber, "C2", "PP99", 5, "0010")
        ];
    ...
    {
        IReadOnlyList<SapConfirmation> result =
        [
            new(confirmation, "1", 15),
            new(confirmation, "2", 7)
        ];
    ...
    {
        IReadOnlyList<SapComponent> result =
        [
            new(orderNumber, "000000000000000111", "SAMOT A"),
            new(orderNumber, "000000000000000222", "PROTEKTOR B"),
            new(orderNumber, "000000000000000333", "SPONKA C"),
            new(orderNumber, "000000000000000444", "OBRO D"),
            new(orderNumber, "000000000000000555", "PAKIRNI OBRO"),
            new(orderNumber, "000000000000000666", "YOUR_TERM_HERE")
        ];
